...
(function () {
  ...
  window.LP.i18n.register({
      ...
      'home.languagesTitle': 'Lasku omalla kielellä',
      'home.languagesLead': 'Valitse asiakkaallesi sopiva paikallinen laskupohja. Jokainen versio tekee valmiin A4-laskun PDF-muotoon.',
      'home.langFiTitle': 'Suomi',
      'home.langFiDesc': 'Suomalainen laskupohja, viitenumerot ja vuoden 2026 ALV-kannat.',
      'home.langFiOpen': 'Tee lasku suomeksi →',
      'home.langDeTitle': 'Deutsch',
      'home.langDeDesc': 'Deutsche Rechnung mit 19 %, 7 % und EU-Reverse-Charge.',
      'home.langDeOpen': 'Rechnung erstellen →',
      'home.langEsTitle': 'Español',
      'home.langEsDesc': 'Factura en español con IVA 21 %, 10 %, 4 % y autoliquidación inversa.',
      'home.langEsOpen': 'Crear factura →',
    ...
    en: {
      ...
      'home.open': 'Open tool →',
      'home.languagesTitle': 'Invoice in your customer’s language',
      'home.languagesLead': 'Choose a localized invoice generator. Each version creates a clean A4 invoice ready to save as PDF.',
      'home.langFiTitle': 'Suomi',
      'home.langFiDesc': 'Finnish invoice fields, payment references and current 2026 VAT rates.',
      'home.langFiOpen': 'Create a Finnish invoice →',
      'home.langDeTitle': 'Deutsch',
      'home.langDeDesc': 'German invoice with 19%, 7% and EU reverse charge.',
      'home.langDeOpen': 'Create a German invoice →',
      'home.langEsTitle': 'Español',
      'home.langEsDesc': 'Spanish invoice with 21%, 10%, 4% and EU reverse charge.',
      'home.langEsOpen': 'Create a Spanish invoice →',
